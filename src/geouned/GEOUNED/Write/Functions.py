...
def open_mc_surface(Type, surf, tolerances, out_xml=True, quadricForm=False):
    if Type == "Plane":
        A = surf.Axis.x
        B = surf.Axis.y
        C = surf.Axis.z
...
def serpent_surface(id, Type, surf, options, tolerance):
    serpent_def = ""
...
def phits_surface(id, Type, surf, options, tolerance):
    phits_def = ""
