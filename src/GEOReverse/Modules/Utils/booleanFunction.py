   ...
   #      print('factorise',valname)
       ...
       if self.level == 0:
          ...
          if len(signedSurf) == len(surfname) :  return None  # means same surface has not positive and negative value
           ...
           for e in self.elements:
              ...
              elif self.operator == 'AND' and res == False : return False
              elif self.operator == 'OR'  and res == True  : return True
    ...
    def evaluate(self,valueSet,CT=None):
        ...
        for e in self.elements:
            ...
            elif op == 'AND' and val == False : return False
            elif op == 'OR'  and val == True  : return True
